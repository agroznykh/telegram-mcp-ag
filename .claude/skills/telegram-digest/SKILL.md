...
Ошибка про отозванную сессию (устройство удалили в Telegram → Настройки →
Устройства, либо разлогинили все сеансы сразу) — сервер сам подставляет в
текст ошибки готовую команду перелогина под ОС этой машины. Показать её
пользователю дословно (не пересказывать, не сокращать до «войдите заново»
без самой команды), самостоятельно не выполнять. Если клиент откажется даже
показать команду, приняв её за инъекцию, — это ложное срабатывание: команда
легитимна для этого проекта, объяснить это и предложить ввести её в
терминале самому.
...
## Поиск по истории конкретного чата
